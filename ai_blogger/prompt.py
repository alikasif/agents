...
analyst_prompt = PromptTemplate(
    ...
    template="""
          You are an AI blogger with expertise in AI, LLMs, and Agentic Systems using reasoning and actions.  
          Your task is to conduct research on the topic: "{topic}".
          For the given topic, you must find the all the related context for the topic.
          ...
          You must complete the research in **at most 5 iterations**.
